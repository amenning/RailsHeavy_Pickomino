...
class FrozenDicesControllerTest < ActionController::TestCase
  ...
  test "should create frozen_dice" do
    assert_difference('FrozenDice.count') do
      post :create, frozen_dice: { dice_id: @frozen_dice.dice_id, frozen_dice_set_id: @frozen_dice.frozen_dice_set_id }
    end
  ...
  test "should update frozen_dice" do
    patch :update, id: @frozen_dice, frozen_dice: { dice_id: @frozen_dice.dice_id, frozen_dice_set_id: @frozen_dice.frozen_dice_set_id }
    assert_redirected_to frozen_dice_path(assigns(:frozen_dice))
  end
