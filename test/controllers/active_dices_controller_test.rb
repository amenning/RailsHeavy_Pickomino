...
class ActiveDicesControllerTest < ActionController::TestCase
  ...
  test "should create active_dice" do
    assert_difference('ActiveDice.count') do
      post :create, active_dice: { active_dice_set_id: @active_dice.active_dice_set_id, can_freeze: @active_dice.can_freeze, dice_id: @active_dice.dice_id }
    end
  ...
  test "should update active_dice" do
    patch :update, id: @active_dice, active_dice: { active_dice_set_id: @active_dice.active_dice_set_id, can_freeze: @active_dice.can_freeze, dice_id: @active_dice.dice_id }
    assert_redirected_to active_dice_path(assigns(:active_dice))
  end
