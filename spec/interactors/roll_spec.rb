...
RSpec.describe Roll, type: :Interactor do
  context 'when given valid active_dice_set, active_dice, and dice objects' do
    it 'should successfully create a filled dice set' do
      mock_dice_return = double('Dice', id: 5, create_random_dice: true)
      mock_dice_build = double('Dice', build: mock_dice_return)

      mock_active_dice_return = double('ActiveDice', id: 4, dice: mock_dice_build)
      mock_active_dice_create = double('ActiveDice', create: mock_active_dice_return)
