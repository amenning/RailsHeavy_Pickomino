...
ActiveRecord::Schema.define(version: 20170223023203) do
  ...
  add_index "active_dices", ["dice_id"], name: "index_active_dices_on_dice_id"
  ...
  add_index "frozen_dices", ["dice_id"], name: "index_frozen_dices_on_dice_id"
